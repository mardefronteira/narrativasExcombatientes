...
function showRelatedScenes(sceneId) {
  // Highlight related scenes
  var relatedScenes = data[ 'scenes' ].filter( d => d[ 'id' ] === sceneId )[ 0 ][ 'related' ];
